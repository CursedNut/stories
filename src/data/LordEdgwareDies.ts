export const LordEdgwareDies = {
  "author": "Агата Кристи",
  "title": "Cмерть лорда эджвера",
  "description": `Известной актрисе муж не давал развод. Вскоре его убила женщина, похожая на его жену, но у неё было прочное алиби…`,
  "content": `Знаменитый детектив Эркюль Пуаро присутствует на концерте американской артистки Карлотты Адамс. Девушка очень талантливо изображает различных известных людей, в том числе и американскую актрису Сильвию Уилкинсон, которая несколько лет назад вышла замуж за богатого лорда Эджвера, но вскоре оставила его.
